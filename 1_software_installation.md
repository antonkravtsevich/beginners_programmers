...
Мотивационная часть, надеюсь, прошла успешно - самое время перейти к практике, установить все то, что понадобится нам для старта обучения, написать и запустить первую крошечную программу, и, в конце концов, ее опубликовать. Штош, приступим!
